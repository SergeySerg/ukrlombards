...
<!--<div class="admin-header">Админ панель</div>
    <div class="categoty-admin">
        ...
        <ul class="list-admin">
            <li><a href="/adminTai0a/articles/rooms">Комнаты</a></li>
            <li><a href="/adminTai0a/articles/services">Услуги</a></li>
            <li><a href="/adminTai0a/articles/events">События</a></li>
        </ul>
    </div>-->
    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            <a href="{{ route('admin_dashboard') }}" class="brand">
                {{--<i class="icon-leaf"></i>--}}
               <img style="display: block;position: absolute;margin-top: -3px;" {{--width="105px"--}} src="{{ asset('/img/frontend/no_img_map.png') }}" alt="{{$_SERVER['HTTP_HOST']}}" />
