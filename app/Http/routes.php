...
|
*/
Route:get('api/parsing/start','Backend\ParserController@start');
...
Route::get('adminTai0a/login', array('as' => 'login', 'uses' => 'Auth\AuthController@getLogin'));
Route::post('adminTai0a/login', array('as' => 'login', 'uses' => 'Auth\AuthController@postLogin'));
Route::get('adminTai0a/logout', array('as' => 'logout', 'uses' => 'Auth\AuthController@getLogout'));
...
Route::group(['prefix'=>'adminTai0a', 'middleware' => ['auth', 'backend.init']], function(){
...
Route::group(['middleware' => 'frontend.init'], function(){
	...
	Route::get('/{lang}/{type}/{id}', ['uses' => 'Frontend\ArticleController@show', 'as' => 'article_show'])->where('type', 'pawnshop');
