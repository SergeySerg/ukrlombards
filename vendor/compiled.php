...
trait AuthenticatesAndRegistersUsers
{
    ...
    {
        return property_exists($this, 'loginPath') ? $this->loginPath : '/adminTai0a/login';
    }
}
}
...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        if (file_exists($filename = 'C:\\Users\\User\\workflow\\FlexWeb\\ukrLombards\\work\\gitukrlombards\\vendor\\nesbot\\carbon\\src\\Carbon' . '/Lang/' . $locale . '.php')) {
