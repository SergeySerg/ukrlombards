...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 23 2017 г., 18:23
...
(13, 0, 0, 'services', 'Послуги@|;Услуги@|;Services@|;', '', '<p>Ми впевнені, що співпраця зі студією &laquo;FLEX-WEB&raquo; принесе вам успіх</p>@|;<p>Мы уверенны, что сотрудничество со студией &laquo;FLEX-WEB&raquo; принесет вам успех</p>@|;<p>We are sure that cooperation with the studio &quot;FLEX-WEB&quot; will bring you success</p>@|;', '@|;@|;@|;', '[]', '{"base":["title","short_description","description","gallery","priority","active","meta_title","meta_description","meta_keywords"],"attributes":{"Картинка послуги":{"type":"files","lang_active":false,"active":false}}}', '0000-00-00 00:00:00', 1, '@|;@|;@|;', '@|;@|;@|;', '@|;@|;@|;', 9, '2017-05-29 12:29:40', '2017-06-23 14:53:39'),
...
(16, 0, 0, 'news', 'Новини@|;Новости@|;News@|;', '', '@|;@|;@|;', '@|;@|;@|;', '[]', '{"base":["title","short_description","description","date","priority","active","meta_title","meta_description","meta_keywords"],"attributes":{"Картинка новини":{"type":"files","lang_active":false,"active":false}}}', '0000-00-00 00:00:00', 1, '@|;@|;@|;', '@|;@|;@|;', '@|;@|;@|;', 8, '2017-06-10 19:57:14', '2017-06-23 14:53:58'),
